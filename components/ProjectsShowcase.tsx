...
const PROJECTS = [
...

  {
    ...
    image:
      "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=2572&auto=format&fit=crop",

    link: "https://brittanychiang.com/",
  },
];

const ProjectFrame = React.memo(
  ({ project }: { project: (typeof PROJECTS)[0] }) => {
    return (
