...
const ProjectFrame = React.memo(({ project }: { project: typeof PROJECTS[0] }) => {
  return (
    <div className="relative shrink-0 w-screen md:w-[85vw] h-[55vh] md:h-[60vh] flex items-center justify-center px-4 md:px-12 transform-gpu">
      {/* Ghost Number - Backface hidden to prevent sub-pixel jitter */}
      <span 
...
export const ProjectsShowcase = () => {
  ...
  const x = useSpring(xTranslate, { 
    stiffness: 20, // Lower stiffness for a "heavier" premium feel
    damping: 22, 
    mass: 0.6,
    restDelta: 0.001 
  });
  ...
  return (
    <ReactLenis root options={{ 
      ...
      <section 
        id="projects" 
        ref={targetRef} 
        className="relative h-[900vh] bg-[#030014]"
        style={{ contentVisibility: 'auto', contain: 'layout' }}
      >
        <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden">
          
          <div className="w-full px-6 md:px-24 mb-10 z-20 pointer-events-none">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="relative">
                <h2 className="text-6xl md:text-[120px] font-black tracking-[-0.08em] text-white leading-[0.75] relative z-10">
        ...
        {/* Ambient Effects - Using low-impact opacity */}
