  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#000000] px-4 sm:px-6 py-20 selection:bg-white selection:text-black">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="absolute -top-[20%] -left-[10%] w-75 h-[300px] md:w-[599px] md:h-[600px] bg-white rounded-full blur-[120px] md:blur-[160px] pointer-events-none z-0 opacity-10" 
      />
