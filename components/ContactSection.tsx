...
export const ContactSection = () => {
  ...
  return (
    // Changed pt-32 to pt-12 to move everything up
    <section className="relative h-[750px] w-full bg-[#030014] flex flex-col overflow-hidden pt-12 pb-20" id="contact">
      
      {/* 1. HEADING POSITION - Moved higher by reducing pt-16 to pt-4 */}
      <div className="w-full px-6 md:px-24 pt-4 z-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            <h2 className="text-6xl md:text-[90px] font-black tracking-[-0.08em] text-white leading-[0.8] relative z-10 uppercase">
      ...
      {/* 2. MAIN EXPERIENCE AREA - Uses flex-1 to stay centered in the middle of the screen */}
