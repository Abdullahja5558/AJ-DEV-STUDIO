    ...
    >
      ...
      <div className="flex items-center gap-12">
        <div className="hidden md:flex flex-col items-end gap-2">
            <span className="text-[10px] font-mono text-white/30 tracking-[0.3em] uppercase">{skill.tag}</span>
  ...
  return (
    <ReactLenis root options={{ lerp: 0.05, duration: 1.5 }}>
      <section
        id="skills"
        ref={containerRef}
        className="relative min-h-screen bg-[#030014] py-40 px-6 md:px-12 overflow-hidden"
      >
          ...
          >
            <div className="max-w-xl">
                <p className="text-white/40 text-2xl font-light leading-snug italic">
                    ...
                    <span className="text-white not-italic font-bold"> user growth and high-performance</span> expectations."
                </p>
            </div>
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 py-4 px-8 rounded-full backdrop-blur-xl">
                ...
                <span className="text-[10px] font-mono text-white/50 tracking-[0.2em] uppercase">Status: Available 2026</span>
            </div>
          </motion.div>
        </div>
